// Small logic for pagination found here:
// https://jasonwatmore.com/post/2016/08/23/angular-2-pagination-example-with-logic-like-google
// This class contains only static methods, no instance required, which means, don't need to be
// a service.
export class PagerUtility {
